  ...
  <div class="research-container">
    ...
    <div class="research-grid">
      ...
      <main class="scientific-body">
        ...
        <!-- 09. Références Bibliographiques -->
        <section id="section9" class="paper-section">
          <h2><span>09.</span> Références Bibliographiques (État de l'Art)</h2>
          <ul class="references-list" style="list-style: none; padding-left: 0; margin-top: 1.5rem;">
            <li style="margin-bottom: 1.5rem; line-height: 1.6;">
              <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">Friston, K. (2010). The free-energy principle: a unified brain theory? Nature Reviews Neuroscience, 11(2), 127-138.</strong>
              <span style="color: var(--text-secondary); font-size: 0.95rem; font-style: italic;">(Fondement théorique de la Surprise Narrative et de la divergence D<sub>KL</sub> utilisée pour l'évaluation des propositions d'actions).</span>
            </li>
            <li style="margin-bottom: 1.5rem; line-height: 1.6;">
              <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">Park, J. S., O'Brien, J. C., Cai, C. J., Morris, M. R., Liang, P., & Bernstein, M. S. (2023). Generative Agents: Interactive Simulacra of Human Behavior. In Proceedings of the ACM Symposium on User Interface Software and Technology (UIST).</strong>
              <span style="color: var(--text-secondary); font-size: 0.95rem; font-style: italic;">(Référence de l'état de l'art pour l'architecture mémorielle des agents, surmontée ici par le filtre adaptatif du budget d'attention A<sub>t</sub>).</span>
            </li>
            <li style="margin-bottom: 1.5rem; line-height: 1.6;">
              <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">Schacter, D. L. (1999). The Seven Sins of Memory: Insights from psychology and cognitive neuroscience. American Psychologist, 54(3), 182-203.</strong>
              <span style="color: var(--text-secondary); font-size: 0.95rem; font-style: italic;">(Ancrage scientifique des mécanismes d'atténuation et d'oubli sélectif implémentés pour contrer le prompt bleeding).</span>
            </li>
            <li style="margin-bottom: 1.5rem; line-height: 1.6;">
              <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">Tenenbaum, J. B., Kemp, C., Griffiths, T. L., & Goodman, N. D. (2011). How to Grow a Mind: Statistics, Structure, and Abstraction. Science, 331(6022), 1279-1285.</strong>
              <span style="color: var(--text-secondary); font-size: 0.95rem; font-style: italic;">(Cadre mathématique des simplexes de probabilité appliqués aux vecteurs de croyances changeantes B<sub>t</sub> dans l'espace d'états de l'agent).</span>
            </li>
            <li style="margin-bottom: 1.5rem; line-height: 1.6;">
              <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., ... & Polosukhin, I. (2017). Attention Is All You Need. Advances in Neural Information Processing Systems, 30.</strong>
              <span style="color: var(--text-secondary); font-size: 0.95rem; font-style: italic;">(Référence technique sur les limites de la fenêtre de contexte des Transformers, justifiant le développement de notre couche d'interface symbolique externe).</span>
            </li>
          </ul>
        </section>
      </main>
